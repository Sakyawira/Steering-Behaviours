...
static std::vector<GLfloat> fullVertices =
{
...
static std::vector<GLfloat> slicedVertices =
{
	// Position				// Color			// Texture Coords
...
static std::vector<GLfloat> slicedVertices2 =
{
	// Position				// Color			// Texture Coords
...
static std::vector<GLfloat> slicedVertices3 =
{
	// Position				// Color			// Texture Coords
...
static std::vector<GLfloat> waterVertices =
{
	// Position				// Color			// Texture Coords
...
static std::vector<GLuint> indicesVector =
{
	0, 4, 3,
...
static std::vector<GLuint> animationIndices =
{
